...
import Wait from "../elements/wait.js";
        ...
        return (
            <div>
                ...
                ">
                    ...
                    <p className="text-xl pb-1">Вычисление очков:</p>
                    <ul className="list-disc pl-6">
                        <li className="text-xl pb-1">В конце каждого раунда сумма ваших очков сохраняется</li>
                        <li className="text-xl pb-1">Финальная сумма очков это сумма очков за все раунды</li>
                    </ul>
